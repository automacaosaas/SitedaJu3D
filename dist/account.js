...
let screen = getSession() ? 'profile' : 'email', email = '', name = '', challenge = null, busy = false, countdown, notice = '';
...
function route(focus = false) {
  ...
  } else screen = routeName === 'pedidos' && getSession() ? 'orders' : getSession() ? 'profile' : 'email';
  render(focus);
