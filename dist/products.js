...
export const PRODUCTS = {
  ...
  dinossauroscopio:{number:'02',category:'oftalmologia',title:'Dinossauroscópio',subtitle:'Capa para retinoscópio',image:'dinossauroscopio.png',catalogImage:'product-dinossauroscopio-cutout.webp',description:'Um dinossauro simpático para acompanhar cada olhar. Capa impressa em 3D, com abertura para encaixar no retinoscópio.',parts:[{id:'body',name:'Corpo',hint:'Cabeça e corpo do dinossauro',default:'sky'},{id:'details',name:'Crista e bolinhas',hint:'A mesma cor nas duas partes',default:'mint'}],fixed:'Os olhos permanecem sempre pretos.'},
